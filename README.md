...
public/         Static assets (van-hero-person.webp/.jpg for the home hero & social card, van-hero.png for About, logo.png / favicon.ico / favicon.png / apple-touch-icon.png, fonts)
```
